            ...
            <div className='container mt-4'>
                <div className='card'>
                    <div className="card-header">
                        <h3 className='text-center'>Sepetteki Ürünler</h3>
                    </div>
                            ...
                            <div className='col-md-4'>
                                <div className='card'>
                                    <div className='card-header'>
                                        ...
                                        <h5 className='alert alert-warning text-center'>Toplam Tutar: {total}</h5>
                                        <hr />
                                        <button type='button' onClick={addOrder} className='btn btn-success w-100'>Ödeme Yap</button>
                                    </div>
                                </div>
                            </div>
                        </div>
